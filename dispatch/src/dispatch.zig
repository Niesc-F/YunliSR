...
pub fn onQueryGateway(_: *httpz.Request, res: *httpz.Response) !void {
    ...
    proto.lua_version = .{ .Const = "7532746" };
    proto.ifix_version = .{ .Const = "0" };
    proto.lua_url = .{ .Const = "https://autopatchos.starrails.com/lua/BetaLive/output_7532746_56867873143f" };
    proto.asset_bundle_url = .{ .Const = "https://autopatchos.starrails.com/asb/BetaLive/output_7532442_b3dee2eb8c58" };
    proto.ex_resource_url = .{ .Const = "https://autopatchos.starrails.com/design_data/BetaLive/output_7550733_777db76a8922" };
